...
namespace ConsoleApp1
{
    class Day2Ex
    {
        ...
        {
            FileStream fs = new FileStream(@"C:\Training\c#\ConsoleApp1\files\course.txt", FileMode.Create, FileAccess.Write);
        ...
        public void read_network()
        {
            ...
            FileStream fs = new FileStream(@"C:\Training\c#\ConsoleApp1\files\network.txt", FileMode.Open, FileAccess.Read);
