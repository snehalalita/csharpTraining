...
namespace FileHandling
{
    class file
    {
        ...
        {
            FileStream fs = new FileStream(@"C:\Training\csharpTraining\Day3\files\day3.txt", FileMode.Create, FileAccess.Write);
        ...
        {
            string[] files = Directory.GetFiles(@"C:\Training\csharpTraining\Day3\files");
        ...
        public void open_file()
        {
            ...
            if (File.Exists(@"C:\Training\csharpTraining\Day3\files\" + name))
            {
                Console.WriteLine("File exists");
                FileStream f = new FileStream(@"C:\Training\csharpTraining\Day3\files\" + name, FileMode.Open, FileAccess.Read);
            ...
            {
                FileStream fs = new FileStream(@"C:\Training\csharpTraining\Day3\files\" + name, FileMode.Create, FileAccess.Write);
        ...
        public void read_file()
        {
            ...
            fw.Close();
            fs.Close();
            FileStream f = new FileStream(@"C:\Training\csharpTraining\Day3\files\day3.txt", FileMode.Open, FileAccess.Read);
            StreamReader fr = new StreamReader(f);
